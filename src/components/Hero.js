  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col justify-end bg-[#0A1128] overflow-hidden pt-44 md:pt-56 pb-8 sm:pb-2">
      ...
      <div className="absolute top-0 left-0 right-0 h-[70vh] sm:h-full w-full z-0 overflow-hidden bg-[#0A1128] pointer-events-none">
        ...
        {/* Deep Multi-stop Dark Overlay: completely smooth fade into #0A1128 with zero line/edge */}
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#0A1128]/50 to-[#0A1128] z-30"></div>
        <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#0A1128] via-[#0A1128]/80 to-transparent z-40"></div>
      </div>
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 text-center mt-auto pt-0 pb-0 -translate-y-5 sm:translate-y-0">
        ...
        {/* 2. CTA Action Buttons (Equal Gap) */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 relative z-30 mt-3.5 md:mt-4">
          <a 
            href="tel:+919990432321" 
            className="btn-glass py-2.5 sm:py-3 px-6 sm:px-7 text-sm sm:text-base font-bold w-full sm:w-[210px] flex items-center justify-center gap-2.5 border border-[var(--color-primary-pink)]/40 hover:border-[var(--color-primary-pink)] hover:bg-[var(--color-primary-pink)]/20 transition-all shadow-[0_0_15px_rgba(234,0,122,0.2)]"
          >
          ...
          <a 
            ...
            className="btn-glass py-2.5 sm:py-3 px-6 sm:px-7 text-sm sm:text-base font-bold w-full sm:w-[210px] flex items-center justify-center gap-2.5 border border-[#25D366]/40 hover:border-[#25D366] hover:bg-[#25D366]/20 transition-all shadow-[0_0_15px_rgba(37,211,102,0.2)]"
          >
