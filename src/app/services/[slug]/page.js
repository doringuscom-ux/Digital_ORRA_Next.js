...
export default function ServiceDetailPage() {
  ...
  const [service, setService] = useState(() => servicesData.find((s) => s.id === slug) || null);
    ...
    return (
      <main className="min-h-screen bg-[#070D1E] text-white flex flex-col justify-between">
        ...
        <div className="container mx-auto px-4 py-32 text-center">
          <h1 className="text-3xl sm:text-5xl font-black text-white mb-4">Service Not Found</h1>
          <p className="text-gray-300 mb-8">The requested service page does not exist or has been relocated.</p>
          <Link 
            href="/services" 
  ...
  return (
    <main className="min-h-screen bg-[#070D1E] text-white selection:bg-pink-500 selection:text-white relative overflow-hidden flex flex-col justify-between">
      <DynamicSeoHead path={`/services/${slug}`} />
      <Navbar />
      ...
      <div className="pt-28 pb-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Related Services - Redesigned Modern Sleek Cards */}
          ...
          <div className="rounded-3xl bg-gradient-to-r from-[#142042] via-[#0D152F] to-[#142042] border border-white/20 p-8 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl">
            <div>
              ...
              <h3 className="text-2xl sm:text-3xl font-black text-white mt-1">Accelerate Your Growth with {service.title}</h3>
